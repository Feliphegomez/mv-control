...
var List = Vue.extend({
  ...
  created: function () {
    var self = this;
    api.get('/status_registrations').then(function (response) {
...
var postEdit = Vue.extend({
  ...
  methods: {
    updatepost: function () {
      var post = this.post;
      api.put('/status_registrations/'+post.id,post).then(function (response) {
...
var postDelete = Vue.extend({
  ...
  methods: {
    deletepost: function () {
      var post = this.post;
      api.delete('/status_registrations/'+post.id).then(function (response) {
        console.log(response.data);
      }).catch(function (error) {
        console.log(error);
      });
...
var Addpost = Vue.extend({
  ...
  methods: {
    createpost: function() {
      var post = this.post;
      api.post('/status_registrations',post).then(function (response) {
