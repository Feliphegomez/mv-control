...
var List = Vue.extend({
  ...
  created: function () {
    var self = this;
    api.get('/environmental_authorities').then(function (response) {
...
var postEdit = Vue.extend({
  ...
  methods: {
    updatepost: function () {
      var post = this.post;
      api.put('/environmental_authorities/'+post.id,post).then(function (response) {
...
var postDelete = Vue.extend({
  ...
  methods: {
    deletepost: function () {
      var post = this.post;
      api.delete('/environmental_authorities/'+post.id).then(function (response) {
        console.log(response.data);
      }).catch(function (error) {
        console.log(error);
      });
...
var Addpost = Vue.extend({
  ...
  methods: {
    createpost: function() {
      var post = this.post;
      api.post('/environmental_authorities',post).then(function (response) {
