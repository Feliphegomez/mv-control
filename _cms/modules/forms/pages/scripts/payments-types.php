...
var List = Vue.extend({
  ...
  created: function () {
    var self = this;
    api.get('/payments_types').then(function (response) {
...
var postEdit = Vue.extend({
  ...
  methods: {
    updatepost: function () {
      var post = this.post;
      api.put('/payments_types/'+post.id,post).then(function (response) {
...
var postDelete = Vue.extend({
  ...
  methods: {
    deletepost: function () {
      var post = this.post;
      api.delete('/payments_types/'+post.id).then(function (response) {
        console.log(response.data);
      }).catch(function (error) {
        console.log(error);
      });
...
var Addpost = Vue.extend({
  ...
  methods: {
    createpost: function() {
      var post = this.post;
      api.post('/payments_types',post).then(function (response) {
