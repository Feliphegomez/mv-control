...
var postEdit = Vue.extend({
  ...
  methods: {
    updatepost: function () {
      var post = this.post;
      api.put('/categorys_lots/'+post.id,post).then(function (response) {
...
var postDelete = Vue.extend({
  ...
  methods: {
    deletepost: function () {
      var post = this.post;
      api.delete('/categorys_lots/'+post.id).then(function (response) {
        console.log(response.data);
      }).catch(function (error) {
        console.log(error);
      });
...
var Addpost = Vue.extend({
  ...
  methods: {
    createpost: function() {
      var post = this.post;
      api.post('/categorys_lots',post).then(function (response) {
