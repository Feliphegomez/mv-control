  ...
  <div>
    ...
    <form v-on:submit="createpost">
      <div class="form-group">
        ...
        <input class="form-control" type="text" id="add-content" v-model="post.identification_number" />
      </div>
      <div class="form-group">
...
<template id="post-edit">
  <div>
    ...
    <form v-on:submit="updatepost">
      <div class="form-group">
        <label for="edit-content"># Identificacion</label>
        <input class="form-control" id="edit-content" v-model="post.identification_number" />
      </div>
      <div class="form-group">
