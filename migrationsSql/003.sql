...
DELETE FROM `attached_files`;
/*!40000 ALTER TABLE `attached_files` DISABLE KEYS */;
INSERT INTO `attached_files` (`id`, `title`, `patch`) VALUES
...
INSERT INTO `citys` (`id`, `name`, `department`, `status`) VALUES
	(1, 'Abriaquí', 5, 1),
	(2, 'Acacías', 50, 1),
	(3, 'Acandí', 27, 1),
	(4, 'Acevedo', 41, 1),
...
-- Volcando datos para la tabla admin_mvcontrol.clients: ~3 rows (aproximadamente)
DELETE FROM `clients`;
/*!40000 ALTER TABLE `clients` DISABLE KEYS */;
INSERT INTO `clients` (`id`, `client_type`, `identification_type`, `identification_number`, `social_reason`, `tradename`, `society_type`, `phone`, `phone_mobile`, `mail`, `address`, `department_city`, `city`, `comments`) VALUES
	(1, 2, 2, '890905055-9', 'EMPRESAS VARIAS DE MEDELLIN E.S.P - EMVARIAS', 'EMPRESAS VARIAS DE MEDELLIN', 3, '4705000', 'TEL200', 'cliente@sincorreo.com', 'CARRERA 58 # 42 - 125', 5, 1, 'Estas son observaciones de un cliente de prueba'),
	(2, 2, 1, '200', 'RS200', 'NOMCOM200', 2, 'TEL200', '(NULL)', 'cliente@sincorreo.com', 'DIR200', 5, 1, 'OBSERVAC200'),
	(8, 1, 1, '1035429360', 'NO APLICA', 'NO APLICA', 1, '2745002', '3005473082', 'FELIPHEGOMEZ@GMAIL.COM', 'PILSEN', 5, 547, 'COMMENTARIOS');
...
DROP TABLE IF EXISTS `departments_citys`;
...
DELETE FROM `departments_citys`;
/*!40000 ALTER TABLE `departments_citys` DISABLE KEYS */;
INSERT INTO `departments_citys` (`id`, `name`) VALUES
	(5, 'ANTIOQUIA'),
	(8, 'ATLÁNTICO'),
	(11, 'BOGOTÁ, D.C.'),
	(13, 'BOLÍVAR'),
...
-- Volcando datos para la tabla admin_mvcontrol.payments_types: ~1 rows (aproximadamente)
DELETE FROM `payments_types`;
/*!40000 ALTER TABLE `payments_types` DISABLE KEYS */;
INSERT INTO `payments_types` (`id`, `name`) VALUES
	(1, 'M');
...
-- Volcando datos para la tabla admin_mvcontrol.services: ~0 rows (aproximadamente)
DELETE FROM `services`;
/*!40000 ALTER TABLE `services` DISABLE KEYS */;
INSERT INTO `services` (`id`, `name`, `payment_type`, `description`, `price`) VALUES
	(1, 'Servicio # 1', 1, 'Descripcion del servicio # 1', '125000');
/*!40000 ALTER TABLE `services` ENABLE KEYS */;

-- Volcando estructura para tabla admin_mvcontrol.society_types
DROP TABLE IF EXISTS `society_types`;
...
DELETE FROM `society_types`;
/*!40000 ALTER TABLE `society_types` DISABLE KEYS */;
INSERT INTO `society_types` (`id`, `name`, `description`) VALUES
