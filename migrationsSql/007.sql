...
-- Volcando estructura de base de datos para admin_mvcontrol
CREATE DATABASE IF NOT EXISTS `admin_mvcontrol` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `admin_mvcontrol`;
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `enable_audit` int(1) DEFAULT '0' COMMENT 'Habilitar interventoria',
  PRIMARY KEY (`id`),
  KEY `id` (`id`),
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.contracts_clients
CREATE TABLE IF NOT EXISTS `contracts_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `number` varchar(50) DEFAULT NULL,
  `consecutive` varchar(50) DEFAULT NULL,
  ...
  KEY `id` (`id`),
  KEY `number` (`number`),
  KEY `consecutive` (`consecutive`),
  KEY `client` (`client`),
  CONSTRAINT `FK_contracts_clients_clients` FOREIGN KEY (`client`) REFERENCES `clients` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.crews
CREATE TABLE IF NOT EXISTS `crews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(50) NOT NULL,
  `supervisor` int(11) NOT NULL,
  `supervisor_e` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`),
  KEY `id` (`id`),
  KEY `code_key` (`code`),
  KEY `FK_employee_crew_persons` (`supervisor`),
  KEY `FK_employee_crew_persons_2` (`supervisor_e`),
  CONSTRAINT `FK_employee_crew_persons` FOREIGN KEY (`supervisor`) REFERENCES `persons` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_employee_crew_persons_2` FOREIGN KEY (`supervisor_e`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.crew_employee
CREATE TABLE IF NOT EXISTS `crew_employee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `FK_drivers_vehicles_vehicles` (`crew`),
  KEY `id` (`id`),
  KEY `FK_crew_vehicles_employee_charges` (`charge`),
  CONSTRAINT `FK_crew_employee_crews` FOREIGN KEY (`crew`) REFERENCES `crews` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `crew_employee_ibfk_1` FOREIGN KEY (`charge`) REFERENCES `employee_charges` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `crew_employee_ibfk_2` FOREIGN KEY (`employee`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.crew_vehicles
CREATE TABLE IF NOT EXISTS `crew_vehicles` (
  ...
  KEY `id` (`id`),
  KEY `FK_crew_vehicles_employee_charges` (`charge`),
  CONSTRAINT `FK_crew_vehicles_employee_charges` FOREIGN KEY (`charge`) REFERENCES `employee_charges` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `crew_vehicles_ibfk_1` FOREIGN KEY (`employee`) REFERENCES `persons` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `crew_vehicles_ibfk_2` FOREIGN KEY (`vehicle`) REFERENCES `vehicles` (`id`) ON UPDATE CASCADE
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.galery_vehicles
CREATE TABLE IF NOT EXISTS `galery_vehicles` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`),
  KEY `FK_galery_vehicles_images` (`image`),
  KEY `FK_galery_vehicles_vehicles` (`vehicle`),
  CONSTRAINT `FK_galery_vehicles_images` FOREIGN KEY (`image`) REFERENCES `images` (`id`) ON UPDATE CASCADE,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.images
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.inspectors_clients
CREATE TABLE IF NOT EXISTS `inspectors_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `client` int(11) NOT NULL,
  `first_name` varchar(50) NOT NULL,
  `second_name` varchar(50) DEFAULT NULL,
  ...
  KEY `id` (`id`),
  KEY `FK_contacts_clients_clients` (`client`),
  CONSTRAINT `inspectors_clients_ibfk_1` FOREIGN KEY (`client`) REFERENCES `clients` (`id`) ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `persons` (
  ...
  CONSTRAINT `FK_persons_severance_funds` FOREIGN KEY (`severance_fund`) REFERENCES `severance_funds` (`id`) ON UPDATE CASCADE,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla admin_mvcontrol.reasons_resignation
CREATE TABLE IF NOT EXISTS `reasons_resignation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Tabla para los usuarios / LogIn';
...
CREATE TABLE IF NOT EXISTS `vehicles` (
  ...
  `rent_cost` varchar(100) NOT NULL COMMENT 'Costo de renta',
